...
with col1:
    ...
    head_l = st.number_input("Head Length", value=0.0)
    skull_w = st.number_input("Skull Width", value=0.0)
    totlngth = st.number_input("Total Length", value=0.0)

with col2:
    footlgth = st.number_input("Foot Length", value=0.0)
    eye = st.number_input("Eye Size", value=0.0)
    chest = st.number_input("Chest Size", value=0.0)
    belly = st.number_input("Belly Size", value=0.0)
